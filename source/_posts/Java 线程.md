...
> 
>
> 大型并发系统环境中使用 Executors 如果不注意会出现系统风险
...
public class ThreadTest {
    public static void main(String[] args) {
       ...
       MyThread myThread1 = new MyThread();
		// 启动多线程需要使用 start 方法，使用 run 方法只能顺序只想
       myThread.start();
       myThread1.start();
    }
...
1. 创建任务对象
   1. 定义一个类实现 Callable 接口，重写call 方法，封装要做的事情，和要返回的数据
...
当多个线程共同操作共享的资源时，线程间通过某种方式告知自己的状态，以防止相互协调，并避免无效的资源争夺
